...
/*La funcion retorna una promesa, resolve es por si la promesa se cumplio, y reject si no se cumplio.
con esto podremos escribirlo con async y await en auth.controller.js*/
